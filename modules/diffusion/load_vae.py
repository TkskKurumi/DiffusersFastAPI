...
def convert_ldm_vae_checkpoint(checkpoint, config):
    ...
    vae_state_dict = {}
    vae_state_dict.update(checkpoint)
...
def load_ldm_vae_ckpt(vae, ckpt):
    print("loading vae %s"%ckpt)
    cfg = vae.config
    
    torch_ckpt = torch.load(ckpt)["state_dict"]
    converted_vae_checkpoint = convert_ldm_vae_checkpoint(torch_ckpt, cfg)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vae_pt", default=None)
